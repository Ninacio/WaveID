...
const highlightPills = [
  "Pitch-shift resilient",
  "Time-stretch aware",
  "Contrastive embeddings",
] as const;

const heroStats: { label: string; value: string }[] = [
  { label: "Robust to transforms", value: "8+" },
  { label: "Query latency", value: "<3s" },
  { label: "Segment resolution", value: "2s" },
];
...
export function GlowyWavesHero() {
  ...
  return (
    <section
      className="relative isolate flex min-h-[calc(100vh-4rem)] w-full items-center justify-center overflow-hidden rounded-3xl border border-border/40 bg-background"
      role="region"
      aria-label="WaveID hero section"
    >
      <canvas
        ref={canvasRef}
